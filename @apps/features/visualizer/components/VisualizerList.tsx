...
import { Button, Div, vars, Modal } from "@shared/bridges/UIBridge";
import {
  GenericPanelLayout,
  ...
  ({
    ...
    const renderItem = useCallback(
      (tool: any, _id: string, _handlers: any) => {
        ...
        return (
          <Div
            style={{ color: vars.text, textAlign: "center", padding: "24px" }}
          >
    ...
    const renderTabLabel = useCallback(
      (tool: any, isActive: boolean, _id: string) => {
        return (
          <span
            style={{
              fontSize: "14px",
