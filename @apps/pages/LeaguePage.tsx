...
function LeaguePage() {
	...
	return model.isEditMode ? (
		<LeagueEditPage
			id={id}
			leagueIdInput={model.leagueIdInput} setLeagueIdInput={model.setLeagueIdInput}
			selectedYear={model.selectedYear} setSelectedYear={model.setSelectedYear}
			leagueBatterStats={model.leagueBatterStats} setLeagueBatterStats={model.setLeagueBatterStats}
			leagueRunnerStats={model.leagueRunnerStats} setLeagueRunnerStats={model.setLeagueRunnerStats}
