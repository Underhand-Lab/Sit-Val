...
const BigInningVisualizer = ({ data, isLineup = false }) => {
  ...
  const varData = isLineup ? ret.variance[batterIdx] : ret.variance;
  ...
  return (
    <div className="result-big-inning">
      <h3 style={{ margin: '0 0 10px 0' }}>빅이닝</h3>
...
export default BigInningVisualizer;